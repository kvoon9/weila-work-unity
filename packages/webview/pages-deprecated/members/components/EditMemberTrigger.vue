...
const editSchema = z.object({
  ...
  dept_id: z.number().default(0).optional(),
  sex: boolNumSchema.optional(),
  avatar: z.string().optional(),
  phone: z.string().length(11).optional(),
  tts: boolNumSchema.default(0).optional(),
  loc_share: boolNumSchema.default(0).optional(),
  track: z.number().default(0).optional(),
})
    ...
    <DialogContent class="max-h-[100vh] overflow-y-scroll pt-0">
      ...
      <div class="max-md:max-h-[30vh]">
        ...
        >
          ...
          <DialogFooter class="flex flex-col gap-2 py-2">
            <Button v-is-loading="isPending" class="w-full" type="submit">
              提交
            </Button>
